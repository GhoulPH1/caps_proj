import { Application as ApplicationWithRelations, Client } from '@fleek-platform/utils-genql-client';
...
export declare class ApplicationsClient {
    ...
    get: ({ id }: GetApplicationArgs) => Promise<Pick<{
        ...
        whiteLabelDomainsPaginated: import("@fleek-platform/utils-genql-client").ApplicationWhiteLabelDomainsWithNestedAggregation;
